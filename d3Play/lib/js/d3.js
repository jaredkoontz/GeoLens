d3 = function () {
    ...
    var pi = Math.PI, tau = 2 * pi, halfpi = pi / 2, epsilon = 1e-6, epsilon2 = epsilon * epsilon,
    ...
    function d3_geo_projectionMutator(projectAt) {
        var project, rotate, projectRotate, projectResample = d3_geo_resample(function (x, y) {
            ...
            }), k = 150, x = 480, y = 250, lambda = 0, phi = 0, deltalambda = 0, deltaphi = 0, deltagamma = 0, deltax,
            deltay, preclip = d3_geo_clipAntimeridian, postclip = d3_identity, clipAngle = null, clipExtent = null, stream;
