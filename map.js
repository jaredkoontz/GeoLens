...
function d3rects() {
    ...
    d3.json("json/rectangles.json", function(collection) {
        ...
        collection.objects.forEach(function(d) {
            ...
            var southWest =new L.LatLng(d.rectangle.coordinates[0][0],
                    d.rectangle.coordinates[0][1]),
                northEast = new L.LatLng(d.rectangle.coordinates[1][0],
        ...
        function update() {
            feature.attr("transform",
                function(d) {
                    return "translate("+
                        map.latLngToLayerPoint(d.LatLngBounds.getNorthEast()).x1 +","+
                        map.latLngToLayerPoint(d.LatLngBounds.getSouthWest()).y1 +")";
                    ...
                    var latln1 = [bottomRight.lat,bottomRight.lon];
                    var latln2 = [topLeft.lat,topLeft.lon];
