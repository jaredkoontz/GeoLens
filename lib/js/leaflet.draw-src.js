 ...
 */
    ...
    L.drawLocal = {
        ...
        edit: {
            toolbar: {
                ...
                buttons: {
                    edit: 'Send Query',
                    editDisabled: 'Make selection before sending query',
                    remove: 'Delete query area.',
                    removeDisabled: 'No queries to delete.'
                }
            },
            handlers: {
                edit: {
            ...
            return [
                {
                    ...
                    handler: new L.EditToolbar.SendQuery(map, {
    ...
    //todo here is handler for send functionality.

    L.EditToolbar.SendQuery = L.Handler.extend({
        statics: {
            TYPE: 'sendQuery'
        },
        ...
        enable: function (e) {
             ...
             * HOME BREWED
             */
            sendJsonpRequest(3, "value", this._map, function (data) {
